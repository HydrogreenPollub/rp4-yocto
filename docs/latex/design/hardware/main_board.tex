...
For large projects it maximizes profits for mass manufacturing.
...
The added complexity and cost makes this a suboptimal solution for this project.
...
It offers built-in \verb|RS485|, \verb|RS232| and \verb|CAN| support. It also features an \verb|RTC|\cite{edgebox-spec}.
