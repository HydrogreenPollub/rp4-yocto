...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{images/yocto/rpi_conf.png}\par
    \caption{RaspberryPI config.txt changes}
    \label{fig:yocto-rpi-conf}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{images/yocto/rpi_cmdline.png}\par
    \caption{RaspberryPI disable kernel logs}
    \label{fig:yocto-rpi-cmdline}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{images/yocto/interfaces.png}\par
    \caption{Networking Interfaces Configuration}
    \label{fig:yocto-interfaces}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{images/yocto/ifplugd.png}\par
    \caption{Interface Hotpluggability Config}
    \label{fig:yocto-ifplugd}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{images/yocto/ifplugd_recipe.png}\par
    \caption{Appending ifplugd recipe}
    \label{fig:yocto-ifplugd-recipe}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{images/yocto/set_password.png}\par
    \caption{Setting root password}
    \label{fig:yocto-password}
\end{figure}
\FloatBarrier
...
In order to display the video feed a graphical interface was required.
\verb|X11| was chosen due to how simple it is to add to a Yocto project. It just had to be added the the image features list.
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{images/yocto/x11.png}\par
    \caption{Adding x11 to the project}
    \label{fig:yocto-x11}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.8\textwidth]{images/yocto/rpi_disp.png}\par
    \caption{Display Configuration}
    \label{fig:yocto-display}
\end{figure}
...
For the competition this idea was dropped due to a significant increase in \verb|RaspberryPI| current usage when using the display.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{images/yocto/capnproto.png}\par
    \caption{Building Capnproto Library}
    \label{fig:yocto-capnproto}
\end{figure}
