...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{images/code/can_bind.png}\par
    \caption{Binding the CAN socket}
    \label{fig:code-can-bind}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.7\textwidth]{images/hardware/steering-wheel.png}\par
    \caption{Steering Wheel Display}
    \label{fig:steering-wheel}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.9\textwidth]{images/code/can_run_read.png}\par
    \caption{Reading CAN packets}
    \label{fig:code-can-run-read}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{images/code/can_run_write.png}\par
    \caption{Writing data to the CAN bus}
    \label{fig:code-can-run-write}
\end{figure}
\FloatBarrier