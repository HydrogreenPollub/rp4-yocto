...
Before being sent the latest data readings are kept in a global variable.
That variable is protected by a mutex, which makes it possible to update the data in multiple threads.

That data is sent via \verb|LoRa| in the form of a \verb|flatbuffer|,
which is a standardized way of packing multiple variables into a buffer in a space efficient and repeatable way.
That data is later unpacked and processed by the base station.
